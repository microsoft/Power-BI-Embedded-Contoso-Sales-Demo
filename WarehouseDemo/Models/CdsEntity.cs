...
namespace WarehouseDemo.Models
{
	...
	public partial class CdsEntity
	{
		public static CdsEntity FromJson(string json) => JsonConvert.DeserializeObject<CdsEntity>(json, WarehouseDemo.Models.Converter.Settings);
	}
	public partial class Activities
	{
		public new static Activities FromJson(string json) => JsonConvert.DeserializeObject<Activities>(json, WarehouseDemo.Models.Converter.Settings);
	}
	public partial class Opportunities
	{
		public new static Opportunities FromJson(string json) => JsonConvert.DeserializeObject<Opportunities>(json, WarehouseDemo.Models.Converter.Settings);
	}
	public partial class Leads
	{
		public new static Leads FromJson(string json) => JsonConvert.DeserializeObject<Leads>(json, WarehouseDemo.Models.Converter.Settings);
	}

	public partial class CdsGetResponse
	{
		public static CdsGetResponse FromJson(string json) => JsonConvert.DeserializeObject<CdsGetResponse>(json, WarehouseDemo.Models.Converter.Settings);
	}

	public partial class Accounts
	{
		public static Accounts FromJson(string json) => JsonConvert.DeserializeObject<Accounts>(json, WarehouseDemo.Models.Converter.Settings);
	}
